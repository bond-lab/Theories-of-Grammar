...
\item \txx{Acronym}: \eng{laser} ``Light Amplification by Stimulated Emission of Radiation'', \eng{hpsg} ``Head-Driven Phrase Structure Grammar'', \txx{UPOL}: ``U[niverzita] P[alackého] [v] Ol[omouci]'', \eng{東大} ``東京大学''
...
\begin{itemize}
\item Next week we will look into some simple theories of grammar and morphology
\end{itemize}
