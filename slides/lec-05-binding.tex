...
[{S  \avm{[ sem & [ mode & prop \\ index & $s$\\
      ...
      [reln & {\bf sleep}\\
      sit & \ \ $s$\\
      sleeper & \ \ $i$  ]  >  ] ]}} [{\avm{\1} NP  \avm{[ sem & [ mode & ref \\ index & $i$\\
      restr & < [reln & {\bf name}\\
      name & \ \ Kim \\
     named & \ \ $i$ ] >  ] ]}} [{\eng{Kim}}]]
...
\avm{\textsc{arg-st} =  < spr $\oplus$ comps >
}
...
cat
[{S} [{\avm{\1} NP$_i$} [{\eng{I}}]]
[{VP \avm{[ < \1 > ]}} [{V \avm{[ spr & < \1 > \\
             comps & < \2, \3 > \\ 
             arg-st & < \1, \2, \3 > ]}} [{\eng{sent}}]]
[{\avm{\2} NP$_j$} [{D} [{\eng{a}}]]
[{N$_j$} [{\eng{letter}}]]]
[{\avm{\3} PP$_i$} [{P$_i$} [{\eng{to}}]]
[{NP$_i$ \avm{[ mode & ana ]}} [{\eng{myself}}]]]]]
\end{forest}
...
[{VP \avm{[ < \1 > ]}} [{V \avm{[ spr & < \1 > \\
             comps & < \2 > \\ 
             arg-st & < \1, \2 > ]}} [{\eng{brought}}]]
[{\avm{\2} NP$_j$} [{D} [{\eng{a}}]]
[{N$_j$} [{\eng{pencil}}]]]
[{\avm{\3} PP$_k$} [{P$_k$ \avm{[ comps & < \1 > \\ 
                   mod & < \2 > \\
                   arg-st & < \1 > ]}} [{\eng{with}}]]
[{NP$_l$ \avm{[ mode & ref ]}} [{\eng{me}}]]]]]
\end{forest}
...
\begin{forest}
cat
[{S} [{VP \avm{[ spr & < \1 NP [ per 2nd \\ num sg ] > ]}} [{V \avm{[ spr & < \1 > ]}} [{\eng{vote}}]]
[{\avm{\3} PP$_i$} [{P$_i$} [{\eng{for}}]]
[{NP$_i$ \avm{[ mode & ana ]}} [{\eng{yourself}}]]]]]
\end{forest}
%\newpage
...
\begin{itemize}
\item[] D \ $\rightarrow$\ \ \avm{NP [CASE & poss ]
}
\end{itemize}
