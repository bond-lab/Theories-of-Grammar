...
\bigskip
\begin{center}
    \avm{< \textnormal{continue}, [{\tiny \val{srv-lxm}}\\[-3ex]
      syn &  [ arg-st & < X,
                  VP [ inf & $+$  ]  ] > \\
      sem & [ index & s$_1$ \\ 
...
cat
[{S\avmbox{A}} [{\avmbox{1} NP$_i$} [{Skeptics}]]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{continue}]]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{to}]]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{question}]]
[{NP$_j$}]]]]]
\end{forest}}
\end{center}

\scalebox{0.7}{\raisebox{16ex}[0ex][0ex]{\small \avm{[ restr & \avmbox{A} < [ reln & \textbf{continue} \\  sit & s$_1$ \\ arg & s$_2$ ], \\
        [ reln & \textbf{question} \\  sit  & s$_2$ \\ doubter & i \\ doubted & j], 
  \ldots > ]
}}}
...
\begin{center} 
  \scalebox{0.55}{\begin{forest}
cat
[{S\avmbox{A}} [{\avmbox{1} NP$_j$}]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{continue}]]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{to}]]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{be}]]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1} > ]}} [{questioned}]]
[{NP$_i$} [{P$_i$} [{by}]]
[{NP$_i$} [{NOM$_i$} [{skeptics}]]]]]]]]]
\end{forest}}
\end{center}
\scalebox{0.7}{\raisebox{20ex}[0ex][0ex]{\small \avm{[ restr & \avmbox{A} <[ reln & \textbf{continue} \\  sit & s$_1$ \\ arg & s$_2$ ], \\
        [ reln & \textbf{question} \\ sit  & s$_2$ \\ doubter & i \\ doubted & j], 
  \ldots > ]
}}}
...
\bigskip
\begin{center}
    \avm{< \textnormal{try}, [{\tiny \val{scv-lxm}}\\[-3ex]
      syn &  [ arg-st & < NP$_i$,
                  VP [ inf & $+$  ]  ] > \\
      sem & [ index & s$_1$ \\ 
...
cat
[{S\avmbox{A}} [{\avmbox{1} NP$_i$}]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1}$_i$ > ]}} [{tried}]]
[{VP \avm{[ \ft{spr} < \avmbox{2}$_i$ > ]}} [{V \avm{[ \ft{spr} < \avmbox{2}$_i$ > ]}} [{to}]]
[{VP \avm{[ \ft{spr} < \avmbox{2}$_i$ > ]}} [{V \avm{[ \ft{spr} < \avmbox{2}$_i$ > ]}} [{arrest}]]
[{NP$_j$}]]]]]
\end{forest}}
\end{center}

\scalebox{0.7}{\raisebox{20ex}[0ex][0ex]{\small \avm{[ restr & \avmbox{A} < 
...
cat
[{S\avmbox{A}} [{\avmbox{1} NP$_j$}]
[{VP \avm{[ \ft{spr} < \avmbox{1} > ]}} [{V \avm{[ \ft{spr} < \avmbox{1}$_j$ > ]}} [{tried}]]
[{VP \avm{[ \ft{spr} < \avmbox{2}$_j$ > ]}} [{V \avm{[ \ft{spr} < \avmbox{2}$_j$ > ]}} [{to}]]
[{VP \avm{[ \ft{spr} < \avmbox{2}$_j$ > ]}} [{V \avm{[ \ft{spr} < \avmbox{2}$_j$ > ]}} [{be}]]
[{VP \avm{[ \ft{spr} < \avmbox{2}$_j$ > ]}} [{V \avm{[ \ft{spr} < \avmbox{2}$_j$ > ]}} [{arrested}]]
[{NP$_i$} [{P$_i$} [{by}]]
[{NP$_i$} [{NOM$_i$} [{the police}]]]]]]]]]
\end{forest}}
\end{center}

\scalebox{0.7}{\raisebox{25ex}[0ex][0ex]{\small \avm{[ restr & \avmbox{A} < 
