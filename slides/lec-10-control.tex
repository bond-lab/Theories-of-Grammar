...
\scalebox{0.7}{\raisebox{16ex}[0ex][0ex]{\small \begin{avm}
      \[ restr & \avmbox{A} \< \[ reln & \textbf{continue} \\  sit & s$_1$ \\ arg & s$_2$ \], \\
...
\vspace*{-2ex}
\begin{center} 
  \scalebox{0.6}{\begin{avmtree}%\renewcommand{\lf}[1]{\br{#1}{}}\avmfont{\sc}
...
\scalebox{0.7}{\raisebox{25ex}[0ex][0ex]{\small \begin{avm}
  \[ restr & \avmbox{A} \< 
