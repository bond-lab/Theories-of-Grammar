...
\item Formulate a lexcial entry for the word \eng{defendants}
  
\item Draw a tree for \eng{The defendents walk}.  Show all the features on all of the nodes and use tags to show identities.

  \item Explain how you the grammar blocks \eng{The defendents walks}.  You should refer to the lexical entries, rules and HFP.
